...
const buttonsBackgroundColor = Color(0xFF7A4495);
const backgroundColor = Color(0xFFB270A2);
const yellowColor = Color(0xFFFF8FB1);
const whiteColor = Color(0xFFFCE2DB);
